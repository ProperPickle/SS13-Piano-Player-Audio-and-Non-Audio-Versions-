...
Instructions:
	Playing a Preset song:
		...
		- Press "Play Selected Preset" button to play the selected preset song, this non-audio version of the code will attempt to play the song using simulated keystrokes, so be sure you have a virtual piano open!
	...
	Playing a new, non-preset song:
		...
		- Press "Play Composed Song" button to play the composed song, this non-audio version of the code will attempt to play the song using simulated keystrokes, so be sure you have a virtual piano open!
...
Tips:
	- When trying to find the correct tempo value for a new song, it may be easier to use the audio version of this code, as it will actually play the song instead of simulating key presses, and will make it immediately obvious if you've entered the correct tempo value.
	- Pressing "F5" should immediately kill the program, mostly used if the simulated keypresses are sending inputs to the wrong application, which normally happens if focus on the correct application is lost.
	- If you find any bugs in the code, or have tips on how to clean it up, please don't hesitate to contact me on GitHub.
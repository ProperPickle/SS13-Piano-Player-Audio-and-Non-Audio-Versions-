...
Instructions:
	Playing a Preset song:
		...
		- Press "Play Selected Preset" button to play the selected preset song, this audio version of the code will audibly play the song.
	...
	Playing a new, non-preset song:
		...
		- Press "Play Composed Song" button to play the composed song, this audio version of the code will audibly play the song.
...
Tips:
	- This audio version of the program is useful for testing tempo values on new songs, as it will make it immediately apparent whether or not the inputted tempo value is correct for the song.
	- Pressing "F5" should immediately kill the program.
